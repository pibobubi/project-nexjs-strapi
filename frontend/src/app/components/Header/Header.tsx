        ...
        <header className={scss.header}>
            <nav className={scss.nav}>
                <ul className={scss.menu}>
                    <li><Button variant={'text'} href={'/'}><Typography variant={'h6'} style={{textTransform: 'initial'}}>Next</Typography></Button></li>
                    <li>
                    ...
                    {!userData ? (
                        ...
                        <>
                            ...
                            <li>
                                <Link href="/manager"><Typography>Manager</Typography></Link>
                            </li>
                        </>
                    )}
                </ul>
